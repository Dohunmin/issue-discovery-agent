...
운영자 취향 등급: 각 후보에 [운영자취향:매우 높음/보통/낮음] 태그가 붙어 있을 수 있습니다.
이것은 운영자의 과거 선호 이력을 기반으로 한 취향 매칭 등급입니다.
- "매우 높음" 후보는 동일 총점일 때 반드시 우선 선정하세요.
- 총점이 1~2점 낮더라도 "매우 높음"이면 선정을 적극 고려하세요.
- "낮음"이라도 총점이 높으면 선정할 수 있습니다.
